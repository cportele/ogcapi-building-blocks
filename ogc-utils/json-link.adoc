...
Web linking according to https://www.rfc-editor.org/rfc/rfc8288.txt[RFC 8288] is used to express relationships between resources. The JSON object representation of links described here is used consistently in OGC API's.
