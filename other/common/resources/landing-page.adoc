...
|`data` |**CONDITIONAL**. Refers to a link:../../../geo/common/resources/collections.adoc[OGC API Collections] resource that represents the root resource of the distributions of a dataset.
...
|`\http://www.opengis.net/def/rel/ogc/1.0/data` |Refers to a link:../../../geo/common/resources/collections.adoc[OGC API Collections] resource that represents the root resource of the distributions of a dataset.
