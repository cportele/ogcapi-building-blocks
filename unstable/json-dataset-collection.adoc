...
The Dataset Collection can be mapped into an [OGC Dataset Record](https://github.com/opengeospatial/ogcapi-records/pull/130), to represent it as 
...
|keywords |[string] |A list of keywords or tag associated with the resource.
|keywordsCodespace |URI | A reference to a controlled vocabulary used for the keywords property.
|language |string | This refers to the natural language used for textual values.
|created |string |The date the dataset was created, formatted according to https://datatracker.ietf.org/doc/html/rfc3339#section-5.6[RFC 3339, section 5.6].
|updated |string |The more recent date on which the dataset was changed, formatted according to https://datatracker.ietf.org/doc/html/rfc3339#section-5.6[RFC 3339, section 5.6].
|publisher |publisher |The entity making the resource available. TODO: Describe the publisher object.
|themes |[string] |A knowledge organization system used to classify the resource.
|contactPoint |[string] An entity to contact about the resource.
