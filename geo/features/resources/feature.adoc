...
A feature. Every feature is a sub-resource of an link:../../common/resources/collection.adoc[OGC Collection].
...
!===
|Link relation type |Description
|`item` |May by used to point to the feature from a static link:../../common/resources/collection.adoc[OGC Collection resource].
!===
