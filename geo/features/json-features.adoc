...
The features in an link:../../common/resources/collection.adoc[OGC Collection].

This resource supports spatial filtering with the link:../../common/parameters/bbox.adoc[`bbox` parameter], temporal filtering with the link:../../../other/common/parameters/datetime.adoc[`datetime` parameter].
...
|features |[ link:feature.adoc[Feature] ] |**REQUIRED**. The features in the collection.
...
!===
|Link relation type |Description
|`items` |From a link:../../common/resources/collection.adoc[OGC Collection resource]. 
