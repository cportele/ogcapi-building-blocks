...
ifdef::env-github[]
include::schemas/header-crs.yaml[]
endif::[]
ifndef::env-github[]
[source,YAML]
----
include::content-crs.yaml[]
----
endif::[]

=== Source Reference

https://portal.ogc.org/files/91976#_coordinate_system_and_axis_order[OGC API - Features, Part 2, 6.3.3: Coordinate System and axis order]